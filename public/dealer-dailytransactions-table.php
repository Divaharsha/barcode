<section class="content-header">
    <h1>
        ...
        <input id="goldsmith_master_id" type="hidden"  value="<?php echo $_GET['id']?>" />
    </h1>
</section>
<?php
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id='users_table' class="table table-hover" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=dealer_daily_transaction" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc" data-show-export="false" data-export-types='["txt","excel"]' data-export-options='{
...
<script>
    ...
    function queryParams(p) {
        return {
            ...
            "goldsmith_master_id": $('#goldsmith_master_id').val(),
            limit: p.limit,
            sort: p.sort,
            order: p.order,
            offset: p.offset,
